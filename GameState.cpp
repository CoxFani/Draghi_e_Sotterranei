...
/******************* SUBJECT *********************/
/*
void GameState::registerObserver(Observer *obs) {

    observers.push_back(obs);
}

void GameState::removeObserver(Observer *obs) {

    observers.remove(obs);
}

void GameState::notifyObserver() {

    for(list<Observer*>::iterator itr = observers.begin(); observers.end() != itr; ++itr){
